...
-- - If using a VM, you may swap '%' back to 'localhost' for the role users.
...
CREATE USER 'executive_manager_role'@'%' IDENTIFIED BY '!executive_manager' PASSWORD EXPIRE NEVER;
...
GRANT SELECT ON EsportLeagueDB.TeamMembers TO 'visitor_role'@'%';
...
GRANT SELECT ON EsportLeagueDB.RolePermissions TO 'visitor_role'@'%';
...
GRANT SELECT ON EsportLeagueDB.RolePermissions TO 'player_role'@'%';
...
GRANT SELECT ON EsportLeagueDB.RolePermissions TO 'coach_role'@'%';
GRANT INSERT ON EsportLeagueDB.Teams TO 'coach_role'@'%';
GRANT INSERT, UPDATE ON EsportLeagueDB.TeamMembers TO 'coach_role'@'%';
...
GRANT SELECT ON EsportLeagueDB.RolePermissions TO 'referee_role'@'%';

-- Executive Manager: top role, full app-level DB access
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.Users TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.Players TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.Coaches TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.Teams TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.TeamMembers TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.Matches TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.MatchTeam TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.Rounds TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.PlayerStats TO 'executive_manager_role'@'%';
GRANT SELECT, INSERT, UPDATE, DELETE ON EsportLeagueDB.TeamStats TO 'executive_manager_role'@'%';
GRANT SELECT ON EsportLeagueDB.Roles TO 'executive_manager_role'@'%';
GRANT SELECT ON EsportLeagueDB.RolePermissions TO 'executive_manager_role'@'%';
